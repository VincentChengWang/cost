							...
							<div id="login-box"
								...
								<div class="widget-body">
									<div class="widget-main">
										...
										<div class="space-6"></div>
										<form action="system/login" method="post" id="loginForm" onsubmit="return check()">
												
											<fieldset>
												<label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input id="userId"
													required="required"	name="userAccount" type="text" class="form-control"
														placeholder="请输入账号" value="${user.userAccount }" /> <i class="icon-user"></i>
												</span>
												</label> <label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input id="userPwd"
													required="required"	name="userPwd" type="password" class="form-control"
