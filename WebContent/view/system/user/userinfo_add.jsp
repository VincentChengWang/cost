...
/* 	 $("#userAccount").blur(function(){
		...
		if(userAccount.length>0){
			 $.post("system/userInfo/validateUser",{userAccount:userAccount},function(data){
...
<form action="system/adduser" id="f1" method="post" class="form-horizontal">
				...
				<div class="form-group ">
					...
					<div class="col-xs-4 ">
						<select name="userRole" class="form-control">
							<option ${user.userRole=='普通员工'?'selected':'' }>普通员工</option>
							<option ${user.userRole=='部门经理'?'selected':'' }>部门经理</option>
							<option ${user.userRole=='财务人员'?'selected':'' }>财务人员</option>
		...
		<div class="row">
			<div class="col-xs-3 col-xs-offset-4">
				<input type="submit" id="submit" class="btn btn-success" value="保存用户" /> <input
