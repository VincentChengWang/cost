				...
				<ul class="nav ace-nav">
					...
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						...
						<ul
							...
							<li><a href="view/system/user/userinfo_show.jsp"  target="mainframe"> <i class="icon-user"></i> 个人资料
							</a></li>

							<li class="divider"></li>

							<li><a href="view/login.jsp"> <i class="icon-off"></i> 退出
							</a></li>
						</ul></li>
				</ul>
				<!-- /.ace-nav -->
						...
						<c:if test="${menu.pid==0 }">
						    <li><a href="javascript:void(0)" target="mainframe"
									class="dropdown-toggle"> <i class="icon-desktop"></i> <span
										class="menu-text"> ${menu.menuName } </span> <b class="arrow icon-angle-down"></b>
								</a>
			
									<ul class="submenu">
										<c:forEach var="child" items="${menus }">
											<c:if test="${child.pid==menu.mid }">
					                            <li><a href="${child.url }" target="mainframe"> <i
