          ...
          <div class="panel-heading"  >
            <span class="glyphicon glyphicon-refresh"></span>薪资发放
              ...
              <div class="panel-body">
				...
				<tbody>
				<c:forEach items="${salaryCharts }" var="st">
					<tr>
						<td><fmt:formatDate value="${st.salaryMonth }"  type="both" pattern="yyyy-MM"/></td>
						<td>${st.salaryBasicTotal }</td>
						<td>${st.salaryCommTotal }</td>
					</tr>
				</c:forEach>	
				</tbody>
				</table>	
